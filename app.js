...
const secretPrefix = "phantom-os-v6-"; 
let maxLimit = 10; 
let isHost = false;
let connections = {}; 
let calls = {};       
...
enableMicBtn.onclick = async () => {
    ...
    try {
        ...
        ghostDryGain.gain.value = 1; // Start Normal
...
ghostBtn.onclick = () => {
    ...
    if(isGhostMode) {
        ghostDryGain.gain.value = 0; // Cut normal voice
        ghostWetGain.gain.value = 1.5; // Boost Robotic Voice
        ...
        ghostDryGain.gain.value = 1; // Normal Voice Back
        ghostWetGain.gain.value = 0; // Cut Robotic Voice
        ghostBtn.innerText = "Ghost 🎭";
